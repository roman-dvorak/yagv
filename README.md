...
A fast 3D Gcode Viewer for Reprap-style 3D printers, in Python and OpenGL/pyglet. Designed in Ubuntu Linux; Expected to work in any Linux, Windows or OS X
